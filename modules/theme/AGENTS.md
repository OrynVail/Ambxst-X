...
| File | Type | Role |
|------|------|------|
| `Colors.qml` | Singleton | Watches `~/.cache/flokshell/colors.json`. Provides reactive palette (`primary`, `secondary`, `surface`, `onSurface`, etc.) |
...
| Task | Location | Notes |
|------|----------|-------|
| **Change colors** | `Colors.qml` | Modify `~/.cache/flokshell/colors.json` or change color preset |
